...
with open('C:/Users/ztf/Desktop/in_the_name_of_people/in_the_name_of_people.txt','rb') as f:
    document = f.read()
    ...
    with open('C:/Users/ztf/Desktop/in_the_name_of_people_segment.txt', 'wb+') as f1:
